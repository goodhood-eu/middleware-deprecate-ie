(function() {
  ...
  inject('head', `
    <style id="${getSelector('css')}" type="text/css">
      ...
      .${getSelector('content')} h1 {
        margin-top: 30px;
        text-align: center;
      }

      .${getSelector('content')} a {
        color: #799189;
        cursor: pointer;
      }
      .${getSelector('content')} a:visited {
        color: #799189;
      }
      .${getSelector('content')} a:active,
      .${getSelector('content')} a:hover {
        color: #575757;
      }

      .${getSelector('controls')} {
        text-align: right;
      }
